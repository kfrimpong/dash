...
#    UserMailer.proposal_notifier(job_user_name, proposal_user_name, job_user_email, job_details, proposal_details).deliver
    respond_to do |format|
      if @user_job_proposal.save  
        format.html { redirect_to @user_job_proposal, notice: 'User job proposal was successfully created.' }
