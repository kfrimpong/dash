 ...
 * Tolltip by Ira\EA Carvalho, irae@irae.pro.br, http://irae.pro.br/en/
 * Copyright (c) 2010 Ira\EA Carvalho
 * Dual licensed under the MIT (filamentgroup.com/examples/mit-license.txt) and GPL (filamentgroup.com/examples/gpl-license.txt) licenses.
 * 	
...
*/
        ...
        _generateHTMLHourCell: function (inst, hour, showPeriod, showLeadingZero) {
            ...
            if (enabled) {
                html = '<td class="ui-timepicker-hour-cell" data-timepicker-instance-id="#' + inst.id.replace(/\\\\/g,"\\") + '" data-hour="' + hour.toString() + '">' +
                   ...
                   (hour == inst.hours ? 'ui-state-highlight' : '') +
                   '">' +
        ...
        _generateHTMLMinuteCell: function (inst, minute, displayText) {
             ...
             if (enabled) {
	             html = '<td class="ui-timepicker-minute-cell" data-timepicker-instance-id="#' + inst.id.replace(/\\\\/g,"\\") + '" data-minute="' + minute.toString() + '" >' +
	                   '<a class="ui-state-default ' +
	                   (minute == inst.minutes ? 'ui-state-highlight' : '') +
	                   '" >' +
	                   displayText +
	                   '</a></td>';
             }
        ...
        */
        ...
        selectHours: function (event) {
            ...
            $td.parents('.ui-timepicker-hours:first').find('a').removeClass('ui-state-highlight');
            $td.children('a').addClass('ui-state-highlight');
            inst.hours = newHours;
        ...
        selectMinutes: function (event) {
            ...
            $td.parents('.ui-timepicker-minutes:first').find('a').removeClass('ui-state-highlight');
            $td.children('a').addClass('ui-state-highlight');
